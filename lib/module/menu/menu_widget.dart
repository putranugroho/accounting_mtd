  ...
  Widget build(BuildContext context) {
    return ExpansionTile(
      ...
      children: [
        ...
        InkWell(
          onTap: () => widget.value.gantimenu(5),
          child: Container(
            width: MediaQuery.of(context).size.width,
            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 16),
            decoration: BoxDecoration(
              color: widget.value.page == 5 ? Colors.white : Colors.transparent,
              borderRadius: BorderRadius.circular(8),
            ),
            child: Row(
              children: [
                Image.asset(
                  ImageAssets.report,
                  height: 30,
                  color: widget.value.page == 5 ? Colors.black : Colors.white,
                ),
                SizedBox(
                  width: 16,
                ),
  ...
  Widget build(BuildContext context) {
    return ExpansionTile(
      ...
      children: [
        ...
        InkWell(
          onTap: () => widget.value.gantimenu(10),
          child: Container(
            width: MediaQuery.of(context).size.width,
            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 16),
            decoration: BoxDecoration(
              color: widget.value.page == 10 ? Colors.white : Colors.transparent,
              borderRadius: BorderRadius.circular(8),
            ),
            child: Row(
              children: [
                Image.asset(
                  ImageAssets.report,
                  height: 30,
                  color: widget.value.page == 10 ? Colors.black : Colors.white,
                ),
                SizedBox(
                  width: 16,
                ),
  ...
  Widget build(BuildContext context) {
    return ExpansionTile(
      ...
      children: [
        ...
        InkWell(
          onTap: () => widget.value.gantimenu(16),
          child: Container(
            width: MediaQuery.of(context).size.width,
            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 16),
            decoration: BoxDecoration(
              color: widget.value.page == 16 ? Colors.white : Colors.transparent,
              borderRadius: BorderRadius.circular(8),
            ),
            child: Row(
              children: [
                Image.asset(
                  ImageAssets.report,
                  height: 30,
                  color: widget.value.page == 16 ? Colors.black : Colors.white,
                ),
                SizedBox(
                  width: 16,
                ),
